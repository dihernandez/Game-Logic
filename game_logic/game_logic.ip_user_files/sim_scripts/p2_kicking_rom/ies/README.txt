...
#
# Generated by export_simulation on Tue Dec 03 18:27:22 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p2_kicking_rom.sh' script.

./p2_kicking_rom.sh -reset_run
...
./p2_kicking_rom.sh -noclean_files

For more information on the script, please type './p2_kicking_rom.sh -help'.
