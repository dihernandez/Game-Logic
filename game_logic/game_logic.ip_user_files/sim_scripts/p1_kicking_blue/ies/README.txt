...
#
# Generated by export_simulation on Mon Dec 02 18:01:18 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_kicking_blue.sh' script.

./p1_kicking_blue.sh -reset_run
...
./p1_kicking_blue.sh -noclean_files

For more information on the script, please type './p1_kicking_blue.sh -help'.
