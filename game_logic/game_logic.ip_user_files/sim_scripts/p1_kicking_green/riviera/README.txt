...
#
# Generated by export_simulation on Mon Dec 02 18:00:13 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_kicking_green.sh' script.

./p1_kicking_green.sh -reset_run
...
./p1_kicking_green.sh -noclean_files

For more information on the script, please type './p1_kicking_green.sh -help'.
