...
#
# Generated by export_simulation on Thu Dec 05 16:42:56 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_motions_blue.sh' script.

./p1_motions_blue.sh -reset_run
...
./p1_motions_blue.sh -noclean_files

For more information on the script, please type './p1_motions_blue.sh -help'.
