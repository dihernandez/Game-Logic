...
#
# Generated by export_simulation on Tue Dec 03 18:39:32 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p2_at_rest_blue.sh' script.

./p2_at_rest_blue.sh -reset_run
...
./p2_at_rest_blue.sh -noclean_files

For more information on the script, please type './p2_at_rest_blue.sh -help'.
