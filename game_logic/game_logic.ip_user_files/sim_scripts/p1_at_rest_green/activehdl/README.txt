...
#
# Generated by export_simulation on Sun Dec 01 14:37:45 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_at_rest_green.sh' script.

./p1_at_rest_green.sh -reset_run
...
./p1_at_rest_green.sh -noclean_files

For more information on the script, please type './p1_at_rest_green.sh -help'.
