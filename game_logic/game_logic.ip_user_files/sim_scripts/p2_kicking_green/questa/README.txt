...
#
# Generated by export_simulation on Tue Dec 03 18:15:11 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p2_kicking_green.sh' script.

./p2_kicking_green.sh -reset_run
...
./p2_kicking_green.sh -noclean_files

For more information on the script, please type './p2_kicking_green.sh -help'.
