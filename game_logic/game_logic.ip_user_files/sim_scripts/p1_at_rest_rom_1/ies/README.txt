...
#
# Generated by export_simulation on Mon Nov 25 18:42:02 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_at_rest_rom.sh' script.

./p1_at_rest_rom.sh -reset_run
...
./p1_at_rest_rom.sh -noclean_files

For more information on the script, please type './p1_at_rest_rom.sh -help'.
