...
#
# Generated by export_simulation on Wed Dec 04 16:23:24 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_motions_red.sh' script.

./p1_motions_red.sh -reset_run
...
./p1_motions_red.sh -noclean_files

For more information on the script, please type './p1_motions_red.sh -help'.
