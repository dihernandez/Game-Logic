...
#
# Generated by export_simulation on Thu Dec 05 16:43:15 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_motions_green.sh' script.

./p1_motions_green.sh -reset_run
...
./p1_motions_green.sh -noclean_files

For more information on the script, please type './p1_motions_green.sh -help'.
