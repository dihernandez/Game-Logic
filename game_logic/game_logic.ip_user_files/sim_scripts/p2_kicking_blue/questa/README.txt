...
#
# Generated by export_simulation on Mon Dec 02 19:51:57 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p2_kicking_blue.sh' script.

./p2_kicking_blue.sh -reset_run
...
./p2_kicking_blue.sh -noclean_files

For more information on the script, please type './p2_kicking_blue.sh -help'.
