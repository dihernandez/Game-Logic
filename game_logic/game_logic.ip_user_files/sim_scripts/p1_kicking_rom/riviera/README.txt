...
#
# Generated by export_simulation on Mon Dec 02 17:37:56 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_kicking_rom.sh' script.

./p1_kicking_rom.sh -reset_run
...
./p1_kicking_rom.sh -noclean_files

For more information on the script, please type './p1_kicking_rom.sh -help'.
