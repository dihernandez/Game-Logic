...
#
# Generated by export_simulation on Mon Dec 02 19:41:20 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p2_at_rest_red.sh' script.

./p2_at_rest_red.sh -reset_run
...
./p2_at_rest_red.sh -noclean_files

For more information on the script, please type './p2_at_rest_red.sh -help'.
