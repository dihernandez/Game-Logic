...
#
# Generated by export_simulation on Thu Dec 05 16:42:33 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p2_motions_blue.sh' script.

./p2_motions_blue.sh -reset_run
...
./p2_motions_blue.sh -noclean_files

For more information on the script, please type './p2_motions_blue.sh -help'.
