...
#
# Generated by export_simulation on Mon Dec 02 17:01:25 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p2_at_rest_rom.sh' script.

./p2_at_rest_rom.sh -reset_run
...
./p2_at_rest_rom.sh -noclean_files

For more information on the script, please type './p2_at_rest_rom.sh -help'.
