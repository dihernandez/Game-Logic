...
#
# Generated by export_simulation on Thu Dec 05 16:41:06 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p2_motions_red.sh' script.

./p2_motions_red.sh -reset_run
...
./p2_motions_red.sh -noclean_files

For more information on the script, please type './p2_motions_red.sh -help'.
