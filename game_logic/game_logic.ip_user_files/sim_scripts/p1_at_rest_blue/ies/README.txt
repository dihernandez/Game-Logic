...
#
# Generated by export_simulation on Mon Nov 25 18:42:16 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_at_rest_blue.sh' script.

./p1_at_rest_blue.sh -reset_run
...
./p1_at_rest_blue.sh -noclean_files

For more information on the script, please type './p1_at_rest_blue.sh -help'.
