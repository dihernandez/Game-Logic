...
#
# Generated by export_simulation on Thu Dec 05 16:06:13 EST 2019
#
################################################################################
...
'-reset_run' switch to the './p1_motions.sh' script.

./p1_motions.sh -reset_run
...
./p1_motions.sh -noclean_files

For more information on the script, please type './p1_motions.sh -help'.
