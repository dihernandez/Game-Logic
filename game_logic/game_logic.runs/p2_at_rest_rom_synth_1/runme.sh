...
HD_PWD='/afs/athena.mit.edu/user/d/i/dianah13/ddl/Game-Logic/game_logic/game_logic.runs/p2_at_rest_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p2_at_rest_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p2_at_rest_rom.tcl
