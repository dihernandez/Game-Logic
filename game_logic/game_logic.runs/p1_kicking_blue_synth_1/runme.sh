...
HD_PWD='/afs/athena.mit.edu/user/d/i/dianah13/ddl/Game-Logic/game_logic/game_logic.runs/p1_kicking_blue_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p1_kicking_blue.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p1_kicking_blue.tcl
