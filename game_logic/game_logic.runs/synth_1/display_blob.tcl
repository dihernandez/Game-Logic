...
synth_design -top display_blob -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef display_blob.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file display_blob_utilization_synth.rpt -pb display_blob_utilization_synth.pb"
